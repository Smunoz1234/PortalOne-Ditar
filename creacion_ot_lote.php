					  	...
					  	<div class="form-group">
							...
							<div class="col-lg-3">
								<select name="LMT" class="form-control select2" id="LMT">
								   ...
								   <?php if($sw==1){
											while($row_LMT=sqlsrv_fetch_array($SQL_LMT)){?>
											<option value="<?php echo $row_LMT['IdArticuloLMT'];?>" <?php if((isset($_GET['LMT']))&&(strcmp($row_LMT['IdArticuloLMT'],$_GET['LMT'])==0)){ echo "selected=\"selected\"";}?>><?php echo $row_LMT['IdArticuloLMT']." - ".$row_LMT['DeArticuloLMT'];?></option>
								  <?php 	}
										}?>
								</select>
							</div>
