...
if($sw==1){	
	...
	$SQL_LMT="";
	if($_GET['Sucursal']!=""){
		$SQL_LMT=Seleccionar("uvw_Sap_tbl_ArticulosLlamadas","*","(CodigoCliente='".$_GET['Cliente']."' and LineaSucursal='".$_GET['Sucursal']."' and Estado='Y') OR IdTipoListaArticulo='2'");
	}	
          ...
          <div class="row">
           <div class="col-lg-12">
			    <div class="ibox-content">
					...
					<div class="row p-md">
						<div class="form-group">
							<label class="col-lg-1 control-label">Lista materiales / artículos</label>
							<div class="col-lg-3">
							...
							<label class="col-lg-1 control-label">Fecha de corte</label>
							...
							<div class="col-lg-1"><button type="button" id="btnNuevo" class="btn btn-success" onClick="AgregarLMT();"><i class="fa fa-plus-circle"></i> Añadir</button></div>
						</div>
					</div>
					<div class="tabs-container">  
						...
						<div class="tab-content">
							<div id="tab-1" class="tab-pane active">
								<iframe id="DataGrid" name="DataGrid" style="border: 0;" width="100%" height="600" src="detalle_cronograma_servicios.php?cardcode=<?php echo base64_encode($_GET['Cliente']);?>&idsucursal=<?php echo base64_encode($_GET['Sucursal']);?>&periodo=<?php echo base64_encode($Anno);?>"></iframe>
							</div>						
						</div>					
					</div>
				</div>
