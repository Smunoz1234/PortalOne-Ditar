...
$SQL=Seleccionar('uvw_Sap_tbl_FacturasCompras','*',"CardCode='".$_SESSION['CodigoSAPProv']."' $WhereFecha $Filtro");
$SQLCons=ReturnCons('uvw_Sap_tbl_FacturasCompras','*',"CardCode='".$_SESSION['CodigoSAPProv']."' $WhereFecha $Filtro");
?>
<!DOCTYPE html>
