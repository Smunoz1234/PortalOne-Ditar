						...
						<div class="tab-content">
							<div id="tabcl-1" class="tab-pane active">
								...
								<div class="form-group">						
									...
									<div class="col-lg-4">
										<label class="checkbox-inline i-checks"><input name="chkProyecto" id="chkProyecto" type="checkbox" value="Y"> Crear el proyecto para este cliente</label>
									</div>						
								</div>
								<div class="form-group">
													...
													<tr>
														...
														<td>
															<div class="checkbox checkbox-success">
																<input type="checkbox" class="chkProp" id="chkProp<?php echo $row['CodigoGrupo'];?>" value="" aria-label="Single checkbox One"><label></label>
															</div>
														</td>
													</tr>
											<?php }?>
