		...
		<tr id="<?php echo $i;?>" onClick="Resaltar('<?php echo $i;?>');">
			...
			<td class="text-center form-inline w-80">
				...
				<?php if(!strstr($row['Validacion'],"OK")){?>
					<button type="button" title="Corregir sucursal" class="btn btn-warning btn-xs" onClick="CorregirSuc(<?php echo $row['ID'];?>);"><i class="fa fa-gavel"></i></button>
				<?php }?>
			</td>
			...
			<td><input size="15" type="text" id="Enero<?php echo $i;?>" name="Enero[]" class="form-control" value="<?php if($row['Enero']!=""){ echo $row['Enero']->format('Y-m-d');}?>" onChange="ActualizarDatos('Enero',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Febrero<?php echo $i;?>" name="Febrero[]" class="form-control" value="<?php if($row['Febrero']!=""){ echo $row['Febrero']->format('Y-m-d');}?>" onChange="ActualizarDatos('Febrero',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Marzo<?php echo $i;?>" name="Marzo[]" class="form-control" value="<?php if($row['Marzo']!=""){ echo $row['Marzo']->format('Y-m-d');}?>" onChange="ActualizarDatos('Marzo',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Abril<?php echo $i;?>" name="Abril[]" class="form-control" value="<?php if($row['Abril']!=""){ echo $row['Abril']->format('Y-m-d');}?>" onChange="ActualizarDatos('Abril',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Mayo<?php echo $i;?>" name="Mayo[]" class="form-control" value="<?php if($row['Mayo']!=""){ echo $row['Mayo']->format('Y-m-d');}?>" onChange="ActualizarDatos('Mayo',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Junio<?php echo $i;?>" name="Junio[]" class="form-control" value="<?php if($row['Junio']!=""){ echo $row['Junio']->format('Y-m-d');}?>" onChange="ActualizarDatos('Junio',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Julio<?php echo $i;?>" name="Julio[]" class="form-control" value="<?php if($row['Julio']!=""){ echo $row['Julio']->format('Y-m-d');}?>" onChange="ActualizarDatos('Julio',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Agosto<?php echo $i;?>" name="Agosto[]" class="form-control" value="<?php if($row['Agosto']!=""){ echo $row['Agosto']->format('Y-m-d');}?>" onChange="ActualizarDatos('Agosto',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Septiembre<?php echo $i;?>" name="Septiembre[]" class="form-control" value="<?php if($row['Septiembre']!=""){ echo $row['Septiembre']->format('Y-m-d');}?>" onChange="ActualizarDatos('Septiembre',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Octubre<?php echo $i;?>" name="Octubre[]" class="form-control" value="<?php if($row['Octubre']!=""){ echo $row['Octubre']->format('Y-m-d');}?>" onChange="ActualizarDatos('Octubre',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Noviembre<?php echo $i;?>" name="Noviembre[]" class="form-control" value="<?php if($row['Noviembre']!=""){ echo $row['Noviembre']->format('Y-m-d');}?>" onChange="ActualizarDatos('Noviembre',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
			<td><input size="15" type="text" id="Diciembre<?php echo $i;?>" name="Diciembre[]" class="form-control" value="<?php if($row['Diciembre']!=""){ echo $row['Diciembre']->format('Y-m-d');}?>" onChange="ActualizarDatos('Diciembre',<?php echo $i;?>,<?php echo $row['ID'];?>);" data-mask="9999-99-99"></td>
