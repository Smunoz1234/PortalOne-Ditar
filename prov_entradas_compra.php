...
if(isset($_GET['Remision'])&&$_GET['Remision']!=""){
	$Filtro.=" and NumAtCard LIKE '%".$_GET['Remision']."%'";
}
...
$SQL=Seleccionar('uvw_Sap_tbl_EntradasCompras','*',"CardCode='".$_SESSION['CodigoSAPProv']."' $WhereFecha $Filtro");
?>
<!DOCTYPE html>
...
<title>Entradas de mercancías/servicio | <?php echo NOMBRE_PORTAL;?></title>
<!-- InstanceEndEditable -->
...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-sm-8">
                    <h2>Entradas de mercancías/servicio</h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li class="active">
                            <strong>Entradas de mercancías/servicio</strong>
                        </li>
                    </ol>
                </div>
            </div>
			 ...
			 <div class="row">
				<div class="col-lg-12">
					<div class="ibox-content">
					  ...
					  <form action="prov_entradas_compra.php" method="get" id="formBuscar" class="form-horizontal">
							...
							<div class="form-group">
						  	...
						  	<div class="form-group">
								<label class="col-lg-1 control-label">Remisión</label>
								<div class="col-lg-3">
									<input name="Remision" type="text" class="form-control" id="Remision" maxlength="100" value="<?php if(isset($_GET['Remision'])&&($_GET['Remision']!="")){ echo $_GET['Remision'];}?>">
								</div>
								<div class="col-lg-8">
           ...
           <div class="col-lg-12">
			...
			<div class="table-responsive">
					...
					<tr class="odd gradeX">
						...
						<td><?php echo $row['DocBaseDocNum'];?></td>
