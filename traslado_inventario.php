		 ...
		 <div class="row">
			<div class="col-lg-12">
				...
				<?php include "includes/spinner.php";?>
					<div class="form-group">
						<div class="col-lg-6">
							<a href="sapdownload.php?id=<?php echo base64_encode('15'); ?>&type=<?php echo base64_encode('2'); ?>&DocKey=<?php echo base64_encode($row['DocEntry']); ?>&ObType=<?php echo base64_encode('67'); ?>&IdFrm=<?php echo base64_encode($row['IdSeries']); ?>&IdReg=<?php echo base64_encode($row_Formato['ID']); ?>" target="_blank" class="btn btn-outline btn-success"><i class="fa fa-download"></i> Descargar formato</a>
